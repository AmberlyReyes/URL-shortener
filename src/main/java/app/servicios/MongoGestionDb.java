...
public class MongoGestionDb<T> {
    ...
    public MongoGestionDb(Class<T> entityClass, String collectionName) {
        ...
        if (mongoClient == null) {
            // Read the connection string from the environment variable MONGO_URL
            String connectionStringValue = System.getenv("MONGO_URL");
            if (connectionStringValue == null || connectionStringValue.isEmpty()) {
                ...
                connectionStringValue = "mongodb://localhost:27017/SusLinks";
            }
